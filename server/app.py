...
"""
FastAPI application for Urgent Chat Prioritizer Environment with Grader endpoints.
...
app = create_app(
    ...
    env_name="urgent_chat_prioritizer",
...
def load_work_prompt() -> str:
    ...
    work_md_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "WORK.md")
...
async def run_baseline(request: dict = None):
    ...
    try:
        ...
        return {"error": f"OpenAI client error: {str(e)}"}
